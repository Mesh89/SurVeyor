...
struct consensus_alignment_metrics_t {
    int length = 0, alt_score = 0, ref_score = 0, aux_ref_score = 0, inferred_missing_aux = 0, covered_edit_distance = 0, local_alt_ref_edit_distance = 0;
    int expected_alt_gain = bcf_int32_missing;
